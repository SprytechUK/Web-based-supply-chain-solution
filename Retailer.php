...
<?php include ("check.php");?>
  <div class="container-fluid">
      ...
      <div class="row">
        <div id="actors" class="col-sm-12"><figure><img class="img" src="distri.svg"><figcaption style="text-align:center">Distributor</figcaption></figure></div>
      </div>

      <div class="row">
        <div id="actorsactive" class="col-sm-12"><figure><img class="imgactive" src="pharmacy.svg"><figcaption style="text-align:center">Pharmacy</figcaption></figure></div>
      </div>
    ...
    <div class="col-sm-9">
								...
								<button class="btn btn-black dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:white;">
															Documents
																	...
																	<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
																		...
																		<a class="dropdown-item" href="DisplayShipmentDist.php" target="container">Shipment Details</a>
																	</div>
							</li>
			<li class="nav-item active">
	        <a class="nav-link" href="approval1.php" target="container" style="padding-left:15px;">Accept shipment</a>
			  </li>
	      	<li class="nav-item active">
	        <a  class="nav-link" href="pharmaTrack.html" style="padding-left:15px;">Track</a>
							...
							<p id="paddinForTracklink" style="padding-top:15px; padding-right:15px; padding-left:500px;">Retailer View</p>
