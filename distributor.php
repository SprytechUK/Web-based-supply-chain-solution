...
<?php include ("check.php");?>
  ...
  <div class="container-fluid">
      ...
      <div class="row">
            ...
            <figure><img class="img" src="manRPB.svg">
      ...
      <div class="row">
        <div id="actorsactive" class="col-sm-12"><figure><img class="imgactive" src="distri.svg"><figcaption style="text-align:center">Distributor</figcaption></figure></div>
      </div>
    ...
    <div class="col-sm-9">
				...
				<li class="nav-item active">
	        <a class="nav-link" href="approval.php" target="container" style="padding-left:15px;">Accept shipment</a>
			  </li>			
	      	<li class="nav-item active">
	        <a class="nav-link" href="shipmentToRetailer.html" target="container" style="padding-left:15px;">Add New Shipment</a>
			  </li>
	        ...
	        <a  class="nav-link" href="pharmaTrack.html" style="padding-left:15px;">Track</a>
							...
							<p id="paddinForTracklink" style="padding-top:15px; padding-right:15px; padding-left:350px;">Distributor View</p>
								...
								<div class="col-sm-4" style="display: none">
									<div class="row">
										<div class="col-sm-12 labels" >
											<button type="button" class="btn btn-outline-success lab">Manufacturer<img class="imgtick"src="https://img..com/nolan/64/000000/checked-2.png"></button>
